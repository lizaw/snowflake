HOL_DB.PUBLIC."sfguide-getting-started-machine-learning"HOL_DB.PUBLIC."sfguide-getting-started-machine-learning"HOL_DB.PUBLIC."sfguide-getting-started-machine-learning"-- Using ACCOUNTADMIN, create a new role for this exercise 
...
MAIN_FILE = 'train_deploy_monitor_ML_in_snowflake.ipynb' QUERY_WAREHOUSE = COMPUTE_WH
...
GRANT CREATE TABLE ON SCHEMA E2E_SNOW_MLOPS_DB.MLOPS_SCHEMA TO ROLE ACCOUNTADMIN;

-- Grant all privileges (if you own the schema)
GRANT ALL PRIVILEGES ON SCHEMA E2E_SNOW_MLOPS_DB.MLOPS_SCHEMA TO ROLE ACCOUNTADMIN;
